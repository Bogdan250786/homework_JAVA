...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            try {
                User.loadUsers();
                // com.ISG.paramud.userJDBC.UserJDBC.showUsersJDBC();
            } catch (Exception e) {
                User.saveUser();
            }
            do {
                ...
                if (answer.trim().equals("login")) {
                    ...
                    do {
                        ...
                        if (!answer.equals("")) {
                            ...
                            if (User.userList.stream().anyMatch(x -> x.getLogin().equals(finalNewLogin) &
                                ...
                                try {
                                    // com.ISG.paramud.userJDBC.UserJDBC.showUsersTable(workingUser.getLogin());
                                ...
                                do {
                                    ...
                                    if (answer.trim().equals("1")) {
                                        ...
                                        workingUser.addBookItem(workingUser, new BookItem(name, phone, email));
                                        System.out.println(workingUser.getPhoneBook());
                                        workingUser.savePhoneBook(workingUser, workingUser.getLogin());
                                        com.ISG.paramud.userJDBC.UserJDBC.addContactJDBC(workingUser.getLogin(), name,
                                                phone, email);
                                    }
                                    ...
                                    if (answer.trim().equals("3")) {
                                        ...
                                        workingUser.savePhoneBook(workingUser, workingUser.getLogin());
                                        com.ISG.paramud.userJDBC.UserJDBC.removeContactJDBC(workingUser.getLogin(),
                                                answer);
                                        // com.ISG.paramud.userJDBC.UserJDBC.showUsersTable(workingUser.getLogin());
                                    }
                    ...
                    do {
                        ...
                        if (newPassword.equals(oldPassword)) {
                            ...
                            com.ISG.paramud.userJDBC.UserJDBC.addUsersJDBC(newLogin, newPassword);
                            com.ISG.paramud.userJDBC.UserJDBC.createUsersTable(newLogin);
